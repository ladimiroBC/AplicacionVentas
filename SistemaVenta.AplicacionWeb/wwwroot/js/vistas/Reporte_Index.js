...
$(document).ready(function () {
    ...
    tablaData = $('#tbdata').DataTable({
        responsive: true,
        "ajax": {
            "url": '/ReporteVenta/VentaReporte?fechaInicio=01/01/1991&fechaFin=01/01/1991',
            "type": "GET",
            "datatype": "json"
        },
        "columns": [
...
$("#btnBuscar").click(function () {
    ...
    let nueva_url = `/ReporteVenta/VentaReporte?fechaInicio=${fechaInicio}&fechaFin=${fechaFin}`;
